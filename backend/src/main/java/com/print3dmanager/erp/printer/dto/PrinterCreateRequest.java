...
@Schema(description = "Dados para cadastro de impressora (status inicial: DISPONIVEL)")
public record PrinterCreateRequest(
        ...
        @Schema(description = "Potência em watts, usada no custo de energia", example = "350")
